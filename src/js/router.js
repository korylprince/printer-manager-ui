...
const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            path: "/buildings/:building_id/locations/create",
            component: AppLocation,
            props: true,
        },
        {
            name: "update-location",
            path: "/buildings/:building_id/locations/:id",
            component: AppLocation,
            props: true,
        },
        ...
        {name: "create-printer", path: "/printers/create", component: AppPrinter},
        {
            ...
            path: "/buildings/:building_id/locations/:location_id/printers/create",
            component: AppPrinter,
            props: true,
        },
        {
            name: "create-model-printer",
            path: "/manufacturers/:manufacturer_id/models/:model_id/printers/create",
            component: AppPrinter,
            props: true,
        },
        {
            name: "update-printer",
            path: "/buildings/:building_id/locations/:location_id/printers/:id",
            component: AppPrinter,
            props: true,
        },
        ...
        {name: "create-model", path: "/models/create", component: AppModel},
        {
            ...
            path: "/manufacturers/:manufacturer_id/models/create",
            component: AppModel,
            props: true,
        },
        {
            name: "update-model",
            path: "/manufacturers/:manufacturer_id/models/:id",
            component: AppModel,
            props: true,
        },
