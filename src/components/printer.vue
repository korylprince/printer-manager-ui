...
export default {
    ...
    methods: {
        ...
        async do_create(
            ...
            try {
                const printer = await this.api_action({
                    action: api.create_printer,
                    params: [building_id, location_id, model_id, hostname, driver_extra],
                })
                this.update_cache([CacheTypes.Printer])
                if (edit) {
                    this.$router.replace({
                        name: "update-printer",
                        params: {building_id, location_id, id: printer.id},
                    })
                } else {
                    this.clean = printer
                    this.$nextTick(() => {
        ...
        async do_update(
            ...
            try {
                ...
                if (location_id !== location_id_new) {
                    ...
                    this.$router.replace({
                        name: "update-printer",
                        params: {building_id: l.building_id, location_id: l.id, id},
                    })
                }
                this.clean = printer
                this.edit = false
