        ...
        select(item) {
            switch (item.type) {
                case CacheTypes.Building:
                    this.$router.push({name: "update-building", params: {id: item.id}})
                    break
                case CacheTypes.Location:
                    this.$router.push({name: "update-location", params: {building_id: item.building_id, id: item.id}})
                    break
                case CacheTypes.Manufacturer:
                    this.$router.push({name: "update-manufacturer", params: {id: item.id}})
                    break
                case CacheTypes.Model:
                    this.$router.push({name: "update-model", params: {manufacturer_id: item.manufacturer_id, id: item.id}})
                    break
                case CacheTypes.Printer:
                    this.$router.push({name: "update-printer", params: {building_id: item.building_id, location_id: item.location_id, id: item.id}})
                    break
